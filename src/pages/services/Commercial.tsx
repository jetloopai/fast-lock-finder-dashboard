...
const Commercial = () => {
  return (
    <Layout>
      <Helmet>
        <title>Commercial Locksmith Services | Business Security | FastLockFinder</title>
        <meta 
          name="description" 
          content="Professional commercial locksmith services for businesses. Access control, master key systems, and emergency commercial lockouts across Chicago suburbs." 
        />
      </Helmet>
