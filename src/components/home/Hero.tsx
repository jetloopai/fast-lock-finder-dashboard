...
const Hero = () => {
  return <section className="relative bg-gradient-to-br from-primary via-primary to-accent text-primary-foreground overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xl text-primary-foreground/90 max-w-lg animate-fade-in-delay">FastLockFinder connects you with licensed, insured locksmiths serving Chicago, Oak Lawn, Lansing, Matteson, Orland Park and 50+ South Suburban communities. Safe, reliable, and available 24/7.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 animate-fade-in-delay">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-accent rounded-full flex items-center justify-center icon-glow" style={{
                animationDelay: '0.5s'
              }}>
          ...
          <div className="relative animate-slide-in-right">
            <img src={heroImage} alt="Professional FastLockFinder locksmith van providing 24/7 emergency locksmith services in Chicago South and Southwest suburbs" title="FastLockFinder Emergency Locksmith Service" className="w-full h-auto rounded-lg shadow-2xl" width="600" height="400" loading="eager" />
          </div>
        </div>
      </div>
    </section>;
